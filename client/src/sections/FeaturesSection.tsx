...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why choose PixelThumb?" text3="Create stunning thumbnails that drive clicks — without the hassle." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI knows what drives virality and designs thumbnails to match.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Increase views using AI-optimized thumbnail designs </h3>
                        <p className="text-slate-300 mt-2">Stop guessing. Start ranking with AI-designed visuals that capture attention</p>
